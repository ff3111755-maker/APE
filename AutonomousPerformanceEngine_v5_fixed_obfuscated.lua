...
local existingGui = UIHost:FindFirstChild("g")
...
local function showToast(_text, _color)
	return
end

onEngineEvent = function(_kind, _e, _extra)
	return
end
