...
local function getUIHost()
    -- PlayerGui is the most reliable rendering target across normal Roblox
    -- LocalScripts and executors. Prefer it instead of silently moving the
    -- dashboard into an executor-specific UI container.
    return playerGui
end
